...
public class DayView extends View implements View.OnCreateContextMenuListener,
    ...
    */
    ...
    public void handleOnResume() {
        ...
        int filterStartHour = Utils.getSharedPreference(mContext, GeneralPreferences.KEY_HOURS_FILTER_START,
                GeneralPreferences.KEY_HOURS_FILTER_START_DEFAULT);
        int filterEndHour = Utils.getSharedPreference(mContext, GeneralPreferences.KEY_HOURS_FILTER_END,
